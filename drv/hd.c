...
//	set_intr_gate(0x2E,&hd_interrupt);
	...
	put_irq_handler(PRI_IDE_IRQ, hd_intr);
...
/* soft reset, should add timeout mechanism */
...
//	reset_ata();
	...
	unsigned cl = inb(0x1f4);
	unsigned ch = inb(0x1f5);
